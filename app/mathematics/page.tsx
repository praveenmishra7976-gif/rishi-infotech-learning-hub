...
const cards = [
  {
    ...
    href: "/mathematics/notes",
    icon: <BookOpen size={40} />,
    color: "bg-blue-600",
  },
  {
    title: "Mathematics MCQ",
    href: "/mathematics/mcq",
    icon: <Brain size={40} />,
    color: "bg-purple-600",
  },
  {
    title: "Mathematics Videos",
    href: "/mathematics/videos",
    icon: <PlayCircle size={40} />,
    color: "bg-red-600",
  },
  {
    title: "Mathematics Downloads",
    href: "/mathematics/downloads",
    icon: <Download size={40} />,
    color: "bg-green-600",
  },
  {
    title: "Formula Sheet",
    href: "/mathematics/formulas",
